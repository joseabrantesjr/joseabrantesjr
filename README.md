...
But wait, there's more! I've delved into the realm of automation, harnessing powerful tools such as Selenium to streamline processes and maximize efficiency. In fact, I'm the proud author of two books on Selenium automation, available worldwide on Amazon. 📚
...
- **RESTful APIs**
- **Front-end Development:** HTML, CSS, JavaScript, Bootsttrap, React
...
Ready to elevate your programming game? Check out my books on Selenium automation, available now on [Amazon](https://www.amazon.com/stores/author/B0CBL7Q68C/allbooks?ingress=0&visitId=17b372c2-7b63-4dff-8591-f65e78b4de1a&store_ref=ap_rdr&ref_=ap_rdr). 📖
